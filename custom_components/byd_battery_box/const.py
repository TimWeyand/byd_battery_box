...
BMS_SENSOR_TYPES = {
    ...
    "max_history_c_v": ["Max history cell voltage", "max_history_c_v", SensorDeviceClass.VOLTAGE, SensorStateClass.MEASUREMENT, "V", "mdi:chart-line", None],
    "min_history_c_v": ["Min history cell voltage", "min_history_c_v", SensorDeviceClass.VOLTAGE, SensorStateClass.MEASUREMENT, "V", "mdi:chart-line", None],
